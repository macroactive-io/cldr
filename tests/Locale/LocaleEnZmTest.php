...
use Macroactive\Cldr\Locale\LocaleEnZm;
...
class LocaleEnZmTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_ZM', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-ZM"', $locale->htmlAttributes());
        self::assertSame('en-ZM', $locale->languageTag());
