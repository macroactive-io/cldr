...
use Macroactive\Cldr\Locale\LocaleEnUg;
...
class LocaleEnUgTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_UG', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-UG"', $locale->htmlAttributes());
        self::assertSame('en-UG', $locale->languageTag());
