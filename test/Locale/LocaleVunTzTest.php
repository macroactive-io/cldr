...
use Macroactive\Cldr\Locale\LocaleVunTz;

class LocaleVunTzTest extends TestCase
{
    public function testProperties(): void
    {
        $locale = new LocaleVunTz();

        self::assertSame(LanguageVun::class, $locale->language()::class);
