...
use Macroactive\Cldr\Locale\LocaleEnKe;
...
class LocaleEnKeTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_KE', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-KE"', $locale->htmlAttributes());
        self::assertSame('en-KE', $locale->languageTag());
