...
use Macroactive\Cldr\Locale\LocaleEnMu;
...
class LocaleEnMuTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_MU', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-MU"', $locale->htmlAttributes());
        self::assertSame('en-MU', $locale->languageTag());
