...
use Macroactive\Cldr\Locale\LocaleEnSg;
...
class LocaleEnSgTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_SG', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-SG"', $locale->htmlAttributes());
        self::assertSame('en-SG', $locale->languageTag());
