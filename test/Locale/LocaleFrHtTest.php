...
use Macroactive\Cldr\Locale\LocaleFrHt;
...
class LocaleFrHtTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame(TerritoryHt::class, $locale->territory()::class);
        self::assertNull($locale->variant());
        self::assertSame('fr_HT', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="fr-HT"', $locale->htmlAttributes());
        self::assertSame('fr-HT', $locale->languageTag());
