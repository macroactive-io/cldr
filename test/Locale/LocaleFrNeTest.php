...
use Macroactive\Cldr\Locale\LocaleFrNe;
...
class LocaleFrNeTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('fr_NE', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="fr-NE"', $locale->htmlAttributes());
        self::assertSame('fr-NE', $locale->languageTag());
