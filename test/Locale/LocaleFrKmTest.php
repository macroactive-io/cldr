...
use Macroactive\Cldr\Locale\LocaleFrKm;
...
class LocaleFrKmTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame(TerritoryKm::class, $locale->territory()::class);
        self::assertNull($locale->variant());
        self::assertSame('fr_KM', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="fr-KM"', $locale->htmlAttributes());
        self::assertSame('fr-KM', $locale->languageTag());
