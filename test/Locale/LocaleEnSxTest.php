...
use Macroactive\Cldr\Locale\LocaleEnSx;
...
class LocaleEnSxTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_SX', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-SX"', $locale->htmlAttributes());
        self::assertSame('en-SX', $locale->languageTag());
