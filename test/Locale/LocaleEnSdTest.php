...
use Macroactive\Cldr\Locale\LocaleEnSd;
...
class LocaleEnSdTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_SD', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-SD"', $locale->htmlAttributes());
        self::assertSame('en-SD', $locale->languageTag());
