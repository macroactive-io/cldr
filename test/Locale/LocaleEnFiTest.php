...
use Macroactive\Cldr\Locale\LocaleEnFi;
...
class LocaleEnFiTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_FI', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-FI"', $locale->htmlAttributes());
        self::assertSame('en-FI', $locale->languageTag());
