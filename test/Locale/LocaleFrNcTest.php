...
use Macroactive\Cldr\Locale\LocaleFrNc;
...
class LocaleFrNcTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame(TerritoryNc::class, $locale->territory()::class);
        self::assertNull($locale->variant());
        self::assertSame('fr_NC', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="fr-NC"', $locale->htmlAttributes());
        self::assertSame('fr-NC', $locale->languageTag());
