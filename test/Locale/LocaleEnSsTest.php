...
use Macroactive\Cldr\Locale\LocaleEnSs;
...
class LocaleEnSsTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame('en_SS', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="en-SS"', $locale->htmlAttributes());
        self::assertSame('en-SS', $locale->languageTag());
