...
use Macroactive\Cldr\Locale\LocaleFrBl;
...
class LocaleFrBlTest extends TestCase
{
    public function testProperties(): void
    {
        ...
        self::assertSame(TerritoryBl::class, $locale->territory()::class);
        self::assertNull($locale->variant());
        self::assertSame('fr_BL', $locale->code());

        self::assertSame('0123456789', $locale->digits('0123456789'));
        self::assertSame('lang="fr-BL"', $locale->htmlAttributes());
        self::assertSame('fr-BL', $locale->languageTag());
