...
/**
 * Tests for the PluralRuleZeroOneOther class
 *
 * @coversNothing
 */
class PluralRuleZeroOneOtherTest extends TestCase
{
    public function testNumberOfPluralForms(): void
    {
        $plural_rule = new PluralRuleZeroOneOther();
    ...
    public function testPluralRules(): void
    {
        ...
        self::assertSame(2, $plural_rule->plural(22));
        self::assertSame(2, $plural_rule->plural(23));
        self::assertSame(2, $plural_rule->plural(24));
        self::assertSame(2, $plural_rule->plural(25));
        self::assertSame(2, $plural_rule->plural(26));
        self::assertSame(2, $plural_rule->plural(27));
        self::assertSame(2, $plural_rule->plural(28));
        self::assertSame(2, $plural_rule->plural(29));
    }
}
